document.addEventListener('DOMContentLoaded', () => {
    ...
    //move tetromino left, unless it's at the edge or another piece is blocking
    function moveLeft() {
        undraw();
    ...
    //move tetromino right, unless it's at the edge or another piece is blocking
    function moveRight() {
        undraw();
    ...
    function rotate() {
        undraw();
        currentRotation++;
        if (currentRotation === current.length) { // reset rotation if it reaches 4
            currentRotation = 0;
        }
        current = theTetrominoes[random][currentRotation];
        draw();
